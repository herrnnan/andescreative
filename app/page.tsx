...
const services = [
  {
    title: "Sitios Web",
    description: "Diseñamos sitios web modernos y responsivos que capturan la esencia de tu marca.",
    Icon: Globe,
  },
  {
    title: "Aplicaciones Web",
    description: "Desarrollamos aplicaciones web robustas y escalables para tu negocio.",
    Icon: Code,
  },
  {
    title: "Sistemas de Gestión",
    description: "Creamos sistemas personalizados para hoteles, restaurantes y control de stock.",
    Icon: Database,
  },
  {
    title: "Diseño UI/UX",
  ...
  },
  {
    ...
    description: "Apps nativas y multiplataforma con diseño moderno y funcional.",
    Icon: Smartphone,
  },
  {
    title: "Consultoría IT",
    description: "Asesoramiento experto para impulsar tu presencia digital.",
    Icon: Mountain,
  },
]
...
const projects = [
  {
    title: "Sistema Hotelero Premium",
    description: "Gestión integral para hoteles boutique con reservas en tiempo real.",
    image: "/placeholder.svg?height=400&width=600",
    tags: ["React", "Node.js", "MongoDB"],
  },
  {
    title: "App de Eventos Sociales",
    description: "Plataforma para la organización de eventos y celebraciones.",
    image: "/placeholder.svg?height=400&width=600",
    tags: ["React Native", "Firebase", "Stripe"],
  },
  {
    title: "Sistema de Restaurantes",
    description: "Software completo para la gestión de restaurantes y delivery.",
    image: "/placeholder.svg?height=400&width=600",
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#001F3F] to-[#4A4E69]">
      ...
      {/* Progress Bar */}
      <motion.div className="fixed top-0 left-0 right-0 h-1 bg-[#A8D8EA] z-50" style={{ scaleX }} />
      ...
      <section id="inicio" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-8">
            Desarrollamos soluciones tecnológicas innovadoras inspiradas en la grandeza de los Andes
          </p>
          <motion.a
            href="#contacto"
      ...
      <section id="servicios" className="relative py-20 px-6">
        ...
        <div className="container relative z-10 mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-[#001F3F]">Nuestros Servicios</h2>
            <p className="text-[#4A4E69] max-w-2xl mx-auto">Soluciones tecnológicas que transforman tu negocio</p>
          </motion.div>
      ...
      <section id="portafolio" className="relative py-20 px-6 overflow-hidden">
        ...
        >
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-[#001F3F]">Nuestro Portafolio</h2>
            <p className="text-[#4A4E69] max-w-2xl mx-auto">Explora algunos de nuestros proyectos más destacados</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <section id="contacto" className="relative py-20 px-6">
        ...
        <div className="container relative z-10 mx-auto max-w-4xl">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-[#001F3F]">Conversemos</h2>
            <p className="text-[#4A4E69]">¿Listo para llevar tu proyecto al siguiente nivel?</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-[#001F3F] mb-2">Nombre</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-[#001F3F] mb-2">Mensaje</label>
                <textarea
                  className="w-full px-4 py-2 rounded-lg border border-[#A8D8EA] focus:outline-none focus:ring-2 focus:ring-[#87CEEB]/50 focus:border-[#87CEEB] transition-colors bg-white/50 backdrop-blur-sm"
                  rows={4}
